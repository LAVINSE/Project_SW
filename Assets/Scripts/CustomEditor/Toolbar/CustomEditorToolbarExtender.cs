...
public static class CustomEditorToolbarExtender
{
    ...
    // GUI 요소들 사이의 간격을 정의할 변수
    public const float space = 10; // 기본 간격
    public const float largeSpace = 20; // 큰 간격
    public const float buttonWidth = 32; // 버튼 너비
    public const float dropdownWidth = 80; // 드롭다운 너비
    public const float playPauseStopWidth = 100; // Play Pause Stop 너비
